...
export type AdminTab = 'OVERVIEW' | 'VERIFY' | 'ITEMS' | 'REPORTS_FEEDBACK' | 'GUIDANCE';
  ...
  return (
    <div className="w-64 bg-brand-900 border-r border-brand-800 flex-shrink-0 hidden lg:flex flex-col">
        <div className="p-6 border-b border-brand-800">
            ...
            <p className="text-xs text-gray-500 mt-1">{language === 'vi' ? `Đăng nhập bởi ${currentUser.name}` : `Logged as ${currentUser.name}`}</p>
        </div>
